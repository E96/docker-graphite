...
An all-in-one image running graphite and carbon-cache. **Version**: 0.9.13.
...
easily by running:
    ...
    docker run -p 80 -p 2003 -p 2004 -p 7002 -d e96ru/graphite
...
For more information, see [the repository](https://github.com/E96/docker-graphite).
